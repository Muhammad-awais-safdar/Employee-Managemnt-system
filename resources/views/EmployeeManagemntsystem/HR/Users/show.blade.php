        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('HR.users.edit', $user->id) }}" class="btn btn-warning btn-sm">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="{{ route('HR.users.index') }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 fw-bold">Team Lead:</div>
                        <div class="col-md-8">{{ $user->teamLead->name ?? 'N/A' }}</div>
                    </div>
                ...
                <div class="card-footer">
                    <form action="{{ route('HR.users.destroy', $user->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
