            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('Admin.leave-types.index') }}">Leave Types</a>
                        </li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex gap-2">
                    <a href="{{ route('Admin.leave-types.edit', $leaveType) }}" class="btn btn-primary">
                        <i class="ti ti-edit"></i> Edit Leave Type
                    </a>
